...
- `EnumerableSet`: Add `Bytes32x2Set` that handles (ordered) pairs of bytes32. ([#5442](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/5442))
